...
class FormCreateKiosk extends Component{
    constructor() {
    ...
    render(){
        ...
        const handleSubmit = () => {
            ...
            const { Name, Quantity, Unitary_quantity, Area_insumo, Id_unit, Stock_max, Stock_min, Stock_alert, Cost,Status } = this.state;
...
export default FormCreateKiosk;